  ...
  return (
    <header className="sticky top-0 z-50">
      ...
      <div className="grid h-16 grid-cols-[1fr_auto_1fr] items-center border-b border-border bg-background/85 px-4 backdrop-blur-md md:h-20 md:px-6 lg:px-10">
            ...
            >
              ...
              <nav className="flex flex-col gap-1 px-5 py-4">
                <SheetClose asChild>
                  <Link
                    to="/collections/all"
                    className="rounded-none px-3 py-3 text-sm text-muted-foreground transition hover:text-foreground"
                  >
                    {t("header.shop")}
                  </Link>
                </SheetClose>
        ...
        <Link
          to="/"
          className="justify-self-center font-display text-2xl tracking-tight md:text-3xl"
        >
          Noewe
        </Link>
